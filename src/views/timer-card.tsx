  ...
  return (
    <div class="group flex items-center gap-4 rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm transition-all hover:shadow-md dark:border-gray-700 dark:bg-gray-800" x-data="{ showDeleteModal: false }">
      ...
      <div class="flex gap-1.5 opacity-0 transition-opacity group-hover:opacity-100">
        <a
          href={`/timers/${timer.id}/edit`}
          class="rounded-lg bg-gray-100 px-2.5 py-1.5 text-xs font-medium text-gray-700 transition-colors hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
        >
          編集
        </a>
        <button
          x-on:click="showDeleteModal = true"
          class="rounded-lg bg-red-50 px-2.5 py-1.5 text-xs font-medium text-red-600 transition-colors hover:bg-red-100 dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-900/50"
        >
          削除
        </button>
      </div>
